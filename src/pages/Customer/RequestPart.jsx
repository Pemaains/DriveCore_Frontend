                        ...
                        <form onSubmit={handleSubmit} style={styles.form}>
                            ...
                            <div style={styles.field}>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    placeholder="Describe the part, vehicle model, year, and any other relevant details..."
                    ...
                    <div style={styles.statusSection}>
                        ...
                        <div style={styles.statusCard}>
                            <div style={styles.statusTop}>
                                ...
                                <span style={request ? styles.statusBadgeActive : styles.statusBadge}>
                            ...
                            {request ? (
                                <div style={styles.statusBody}>
                                    ...
                                    <div style={styles.statusRow}>
                                        ...
                                        <span style={styles.statusVal}>#{String(request.id).padStart(4, '0')}</span>
                                    </div>
                                    <div style={styles.statusRow}>
                                        <span style={styles.statusKey}>Customer</span>
                                        <span style={styles.statusVal}>{request.customerId}</span>
                                    </div>
                                    <div style={styles.statusRow}>
                                        <span style={styles.statusKey}>Part</span>
                                        <span style={styles.statusVal}>{request.partName}</span>
                                    </div>
                                    {request.description && (
                                        <div style={styles.statusRow}>
                                            <span style={styles.statusKey}>Details</span>
                                            <span style={styles.statusVal}>{request.description}</span>
                                        </div>
                                    )}
                                    <div style={styles.statusRow}>
                                        <span style={styles.statusKey}>Submitted</span>
                                        <span style={styles.statusVal}>{new Date(request.requestedAt).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</span>
                                    </div>
                                    <div style={styles.statusDivider} />
